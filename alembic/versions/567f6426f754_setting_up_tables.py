...
Revision ID: 567f6426f754
Revises: 
Create Date: 2024-07-12 11:53:02.496252
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['start_location_id'], ['locations.location_id'], ),
    sa.PrimaryKeyConstraint('road_id')
    )
    op.create_index(op.f('ix_roads_construction_year'), 'roads', ['construction_year'], unique=False)
    op.create_index(op.f('ix_roads_name'), 'roads', ['name'], unique=False)
    op.create_index(op.f('ix_roads_road_id'), 'roads', ['road_id'], unique=False)
